...
GUARANTEES:
- EVERY asset is explicitly declared
- Script structure is FIXED:
  1. Hook
  2. What happened
  3. To whom
  4. When / discovery
  ...
  6. Context
  7. CTA + loop
- CI FAILS if any asset is missing or undeclared
- NO AI / NO API / NO RANDOM GENERATION
"""
...
def main():
    ...
    print("✅ Script generated. All assets validated. No missing files.")
